...
\edvnr{951 990}
\titel{Praktikumsbericht bei DesCap GmbH - Bouchéstraße 12, Halle 20, 12435 Berlin} 
\untertitel{Pratikumsdauer: 1 Oktober 2025 - 1 April 2026}
\betreuerFeld{
  \begin{tabular}{lr}
    \multicolumn{2}{l}{\textbf{Betreuer}}\\
    Prof.~Dr.~Peter Gober & Berliner Hochschule für Technik\\
    Christopher Böhm& DesCap GmbHm
  \end{tabular}
}
