...
alle zum Mittagsessen in der Schindler-Mensa eingeladen. % TODO:

\begin{figure}[htbp] % Das !ht ist die stabilste Alternative zu [H] ohne extra Paket
    \centering
    \includegraphics[width=0.8\textwidth]{pcb} 
    \caption{Mein allererstes PCB bei DesCap}
    \label{fig:mein_bild}
\end{figure}
...
\begin{figure}[H] % Das !ht ist die stabilste Alternative zu [H] ohne extra Paket
    \centering
    \includegraphics[width=0.8\textwidth]{usb} 
    \caption{Schwierigkeiten beim Routen des USB-Stecker}
    \label{fig:usb}
\end{figure}
